...
class Constants {
    static final String M_ENTITY = "WAREHOUSE"
    static final String M_SOAP_SAVE_ACTION = "SAVE_WAREHOUSE"
    static final String M_SOAP_GET_ACTION = "GET_WAREHOUSE"
    static final String SapEndpoint = "Warehouses"
