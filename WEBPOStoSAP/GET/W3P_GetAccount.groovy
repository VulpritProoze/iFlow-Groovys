...
class Constants {
    static final String STEP_NAME = "W3P_GetAccount"
    static final String ACTION = "GET_ACCOUNT"
    ...
    static final String NEW_BATCHID_PROP_NAME = "ITGWEPOSSAPINTEGRATION3_GetAccount_fnew_batchid"
    static final String LAST_BATCHID_PROP_NAME = "ITGWEPOSSAPINTEGRATION3_GetAccount_flast_batchid"
    static final String LAST_KEY_PROP_NAME = "ITGWEPOSSAPINTEGRATION3_GetAccount_flast_key"
    static final String FDONE_PROP_NAME = "ITGWEPOSSAPINTEGRATION3_GetAccount_fdone"
}
