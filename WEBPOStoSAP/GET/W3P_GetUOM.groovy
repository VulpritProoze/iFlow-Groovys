...
class Constants {
    ...
    static final String NEW_BATCHID_PROP_NAME = "[ProjectName]_GetUoM_fnew_batchid"
    static final String LAST_BATCHID_PROP_NAME = "[ProjectName]_GetUoM_flast_batchid"
    static final String LAST_KEY_PROP_NAME = "[ProjectName]_GetUoM_flast_key"
    static final String FDONE_PROP_NAME = "[ProjectName]_GetUoM_fdone"
}
